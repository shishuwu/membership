...
Source Database       : db_membership2
...
CREATE TABLE `exchange_record` (
  ...
  CONSTRAINT `FKshbsm33hs4ck8c5b9f8mh9qem` FOREIGN KEY (`member_id`) REFERENCES `member2` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of member2
-- ----------------------------
INSERT INTO `member2` VALUES ('2017121514185175', '123', '2018-04-13', '535', 'sdhfhsdf', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '122222222', '男', '正常', '1', '123455892@qq.com', '/assets/icon/01.jpg');
INSERT INTO `member2` VALUES ('20171215142401745', '0', '2017-12-05', '200', '123333', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '12323123123', '女', '停用', '1', '12312@qq.com', '/assets/icon/01.jpg');
INSERT INTO `member2` VALUES ('20171215143150425', '0', '2013-12-21', '201', '123', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '123', '女', '挂失', '1', '1111@qq.com', '/assets/icon/01.jpg');
INSERT INTO `member2` VALUES ('20171215143945448', '100.1', '2017-12-31', '0', '123', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '123213123123', '女', '正常', '2', '123455892@qq.com', '/assets/icon/01.jpg');
INSERT INTO `member2` VALUES ('20171220163147750', '0', '2017-12-21', '0', '骚男', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '12312312312', '男', '正常', '1', '2222@163.com', '/static/assets/icon/e45c34da0e5748f8aa78929cf45d6a0c.jpg');
INSERT INTO `member2` VALUES ('20171220163440900', '0', '2017-12-21', '0', '哈哈', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '2131231231231', '女', '正常', '2', '222222@163.com', '/assets/icon/aaf5ebe176d0415eb0667d88d3a5162f.jpg');
INSERT INTO `member2` VALUES ('2017122121594813', '0', '2017-12-17', '0', '我是会员', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '020-2222222222', '男', '正常', '1', '123123@qq.com', '/static/assets/icon/common.jpg');
INSERT INTO `member2` VALUES ('20180425140053754', '0', '2018-04-25', '0', '123', '$2a$10$w.jltPc24a/IBnBZC4.SJ.JrWJ2gR0h5j4d4/qdn3cV4bwe1bRBLK', '1111', '男', '正常', '1', '123455892@qq.com', '/assets/icon/98e450358a41485385e33a39ec6b6a45.jpg');
INSERT INTO `member2` VALUES ('20180509220432554', '0', '2018-05-12', '0', '啊啊啊', '$2a$10$rodvsbUqsbItp2Kf13zpk.l5XYrW27/JnxigTHtq5v.e/leAIBrSu', '12333333', '女', '挂失', '3', '123455892@qq.com', '/assets/icon/common.jpg');
...
CREATE TABLE `transaction_record` (
  ...
  CONSTRAINT `FKc0uvpwiqycu4oxaxpik7hmli1` FOREIGN KEY (`member_id`) REFERENCES `member2` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
